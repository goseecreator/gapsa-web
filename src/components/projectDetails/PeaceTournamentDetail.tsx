    ...
    <Container maxW="3xl" px={{ base: 4, md: 8 }} py={{ base: 6, md: 10 }}>
      ...
      >
        ...
        <Stack direction={{ base: "column", sm: "row" }} spacing={4} mb={6} aria-label="Top Call To Actions">
          <Button as={RouterLink} to="/donate" colorScheme="blue" aria-label="Donate to Peace Tournament">Donate</Button>
          <Button as={RouterLink} to="/contact" colorScheme="teal" aria-label="Contact the Peace Tournament Team">Contact</Button>
        </Stack>

        <Heading id="peace-tournament-heading" size="lg" mb={4} color={headingColor}>Peace Tournament 2025</Heading>

        <VisuallyHidden as="p">Detailed description of the Peace Tournament in Nakivale Refugee Camp, Uganda.</VisuallyHidden>
        ...
        <Stack spacing={4} color={textColor} fontSize={{ base: "sm", md: "md" }}>
          ...
          <Text>
            The Football Tournaments promote peace through fair play and healthy relating. The Arts and Musical Tournaments showcase and support the talents of refugee children.
            By fostering social cohesion and promoting peace among refugees, we aim to create an environment that allows children to thrive and find solace away from the stress associated with their displacement.
          </Text>
        </Stack>
        ...
        <Tabs variant="soft-rounded" colorScheme="blue" mt={10} isLazy>
          ...
          <TabPanels>
            <TabPanel>
              <MotionStack initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                <Stack spacing={4} color={textColor} fontSize={{ base: "sm", md: "md" }}>
                  <Text>The main objective of organizing the Peace Tournament in the Refugee Community is to provide a platform for refugee families to not only showcase their sporting, musical, and arts’ prowess, but also to promote unity, understanding, and integration within the international community that comprises the Nakivale Settlement.</Text>
            ...
            <TabPanel>
              <MotionStack initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                <Stack spacing={4} color={textColor} fontSize={{ base: "sm", md: "md" }}>
                  <Text>The importance of organizing such an event cannot be overstated. Beyond the obvious benefits of physical activity and skill development, we offer community peace culture education sessions covering peace building, conflict resolution, non-violent communication, and inclusion.</Text>
                  <Text>We have also planned engaging games for children from each of the refugee communities of Nakivale for whole families to participate in throughout the event.</Text>
                </Stack>
              </MotionStack>
            </TabPanel>
            ...
            <TabPanel>
              <MotionStack initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                <Stack spacing={4} color={textColor} fontSize={{ base: "sm", md: "md" }}>
                  <Text>Fosters unity among refugee children, builds peaceful relationships, and nurtures community strength through adult role models.</Text>
                  <Text>Over time, supportive dialogue and unity have become the foundation of friendship and trust. The youth observe adults choosing peace, and that plants the seeds of hope.</Text>
                </Stack>
              </MotionStack>
            </TabPanel>
            ...
            <TabPanel>
              <MotionStack initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
                <Stack spacing={4} color={textColor} fontSize={{ base: "sm", md: "md" }}>
                  <Text>More than sport—it is a testimony to the strength and resilience of the refugee community. Your support empowers youth to shape a peaceful future.</Text>
                  <Text fontWeight="bold">Thank you for supporting The Alliance for Peace & Solidarity for Africa and the Nakivale Refugee Settlement in Uganda.</Text>
                </Stack>
              </MotionStack>
            </TabPanel>
          </TabPanels>
